...
var { is, defineProperty, getOwnPropertyDescriptor, getOwnPropertyNames, getOwnPropertySymbols, getPrototypeOf } =
  Object
...
var getTemplateHtml = (strings, type) => {
  ...
  const htmlResult =
    html2 + (strings[l] || '<?>') + (type === SVG_RESULT ? '</svg>' : type === MATHML_RESULT ? '</math>' : '')
...
__legacyDecorateClassTS([property({ type: Boolean, reflect: true })], DtSwitch.prototype, 'checked', undefined)
__legacyDecorateClassTS([property({ type: Boolean, reflect: true })], DtSwitch.prototype, 'disabled', undefined)
__legacyDecorateClassTS([property({ type: String })], DtSwitch.prototype, 'label', undefined)
DtSwitch = __legacyDecorateClassTS([customElement('dt-switch')], DtSwitch)
...
__legacyDecorateClassTS([property({ type: String, reflect: true })], DtButton.prototype, 'size', undefined)
__legacyDecorateClassTS([property({ type: Boolean, reflect: true })], DtButton.prototype, 'disabled', undefined)
__legacyDecorateClassTS([property({ type: Boolean, reflect: true })], DtButton.prototype, 'active', undefined)
__legacyDecorateClassTS([property({ type: String })], DtButton.prototype, 'label', undefined)
__legacyDecorateClassTS([property({ type: String })], DtButton.prototype, 'tooltip', undefined)
DtButton = __legacyDecorateClassTS([customElement('dt-button')], DtButton)
...
__legacyDecorateClassTS([property({ type: String, reflect: true })], DtIcon.prototype, 'name', undefined)
__legacyDecorateClassTS([property({ type: Number })], DtIcon.prototype, 'size', undefined)
DtIcon = __legacyDecorateClassTS([customElement('dt-icon')], DtIcon)
...
__legacyDecorateClassTS([state()], FrontendDevtools.prototype, '_enabled', undefined)
__legacyDecorateClassTS([state()], FrontendDevtools.prototype, '_inspectActive', undefined)
FrontendDevtools = __legacyDecorateClassTS([customElement('frontend-devtools')], FrontendDevtools)
export { FrontendDevtools }